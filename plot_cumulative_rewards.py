...
# Loop over each average model performance to add it to initalized figure.
for filename in files_list:
    ...
    episodes = np.arange(policy_rewards.shape[0]) * int(sample_freq) # Use sample frequency to recreate the x-axis.

    # TODO: remember that we're plotting the AVERAGE cum_rewards over many seeds.
