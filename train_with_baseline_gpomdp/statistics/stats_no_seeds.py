...
# Average over seeds
for key in stats.keys():
    stats[key]['variance'] = np.mean(stats[key]['variance'])
    stats[key]['kurtosis'] = np.mean(stats[key]['kurtosis'])
...
# Plotting statistics
create_plot(stats, 'CartPole_v1', 'variance')
create_plot(stats, 'CartPole_v1', 'kurtosis')
